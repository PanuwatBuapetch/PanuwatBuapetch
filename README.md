...
* **บทบาท:** Software Developer (ส่วนหนึ่งของ EDOC-PSU Team)
* **รายละเอียด:** พัฒนาระบบศูนย์กลางสำหรับจัดการ ออกเลข และติดตามเอกสารอิเล็กทรอนิกส์ของมหาวิทยาลัย
* **เทคโนโลยี:** Blazor, .NET 6, ASP.NET Core API, **Neo4j (Graph Database)**

#### **2. HRMS - Human Resources Management System (Co-op Project)**
* **บทบาท:** Software Developer Trainee (นักศึกษาสหกิจ)
