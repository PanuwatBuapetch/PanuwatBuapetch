...
<h3 align="center">สวัสดีครับผมชื่อนายภานุวัฒน์ บัวเพชร จบมาจาก มหาวิทยาลัยสงขลานครินทร์ คณะวิทยาศาสตร์ สาขาเทคโนโลยีสารสนเทศ(ต่อเนื่อง)</h3>
<h3 align="center">Graph Database (Neo4j) | PostgreSQL | ASP.NET Core | Nuxt.js</h3>
...
นักพัฒนา .NET ที่มีประสบการณ์ 1 ปี ที่มหาวิทยาลัยสงขลานครินทร์ เชี่ยวชาญด้าน ASP.NET Core และ Blazor มีความเชี่ยวชาญสูงในการสร้าง RESTful API (HttpClient, Swagger) และการพัฒนา UI แบบอินเทอร์แอคทีฟ
ปัจจุบันกำลังขยายขอบเขตความรู้ไปสู่ **Modern Frontend Frameworks** โดยเฉพาะ **Vue.js และ Nuxt.js** เพื่อก้าวสู่การเป็น Fullstack Developer ที่ครอบคลุมเทคโนโลยีสมัยใหม่
...
### 💡 ทักษะที่กำลังพัฒนา (Learning Path)

ผมกำลังขยายขอบเขตความสามารถในการพัฒนาของตัวเอง โดยให้ความสนใจและฝึกฝนเครื่องมือเหล่านี้เป็นพิเศษ:
* **Nuxt.js & Vue.js:** กำลังศึกษาและพัฒนาโปรเจกต์ด้วย Nuxt 3 เพื่อสร้าง Web Application แบบ Modern SSR และ Fullstack
...
* **รายละเอียด:** พัฒนาฟีเจอร์ระบบออกเลขและพัฒนาระบบTDX ส่งเอกสารระหว่างมหาวิทยาลัย 3 แห่ง ในระบบเอกสารอิเล็กทรอนิกส์ของมหาวิทยาลัย
...
#### **1. HRMS PRO (Nuxt Edition)**
* **บทบาท:** Fullstack Developer
* **รายละเอียด:** ระบบบริหารจัดการทรัพยากรบุคคล พร้อมระบบลงเวลา (Attendance), Dashboard สรุปผล และระบบคำนวณเงินเดือน (Payroll) พร้อมออกสลิป PDF
* **เทคโนโลยี:** **Nuxt.js 3**, **Vue.js**, Prisma ORM, Tailwind CSS, MySQL
* > [GitHub Repository](https://github.com/PanuwatBuapetch/hrms-nuxt-project)

#### **2. HRMS - Human Resources Management System (.NET)**
...
* > [GitHub Repository](https://github.com/panuwatbuapetch/HRMSProject)
